# NLT-DEV-OTOI.md Mirror — asfdk-java

This is a mirror of the canonical organization-wide agent contract. For the authoritative version, see `NeuroLift-Technologies/.github-private/NLT-DEV-OTOI.md`.

**Document ID:** ORG-DEV-OTOI-1.0.3 (matching org standard)
...
2. Read the repo-level AGENTS.md (if present)
...
| Action | Protocol |
|---|---|
| Session start | Read OTOI → read repo AGENTS.md → read active-threads → register |
